...
{
    [Serializable]
    internal sealed class BeltConveyorReference : IReference
    {
        ...
        private void Rearrange(bool isCenter)
        {
            try
            {
                ...
                for (int i = 0; i < len; i++)
                {
                    ...
                    large.gameObject.layer = SCake.Entity.UnhitLayer;
                    medium.gameObject.layer = SCake.Entity.UnhitLayer;
                    small.gameObject.layer = SCake.Entity.UnhitLayer;
